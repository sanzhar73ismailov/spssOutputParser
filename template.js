...
template.set(
	"ChiSquared",
	`
Цель: Оценить наличие различий в частоте вариантов "{Переменная}" между 2-мя группами: "{Группа 1}" и "{Группа 2}"
  
Обоснование выбора метода:
	Параметр "{Переменная}" является качественным. 
	Более двух групп сравнения.
Метод сранения:  Критерий χ2.
